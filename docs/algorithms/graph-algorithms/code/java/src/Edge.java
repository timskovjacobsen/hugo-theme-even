...
public class Edge<T> implements Comparable<Edge<? super T>> {
    ...
    /**
     * Creates a directed edge from vertex u to vertex v. Any single edge is always
     * directed, so if you're trying to create an undirected edge, you must create
     * the edges (u, v, weight) and (v, u, weight) when creating the graph.
     *
