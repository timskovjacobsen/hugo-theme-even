...
/**
 * A class representing a directed graph, with a vertex set, edge set, and an
 * adjacency list.
 */
public class Graph<T> {
    ...
    /**
     * Builds the graph from a set of vertices and an edge list. All edges in the
     * edge set are assumed to be directed, so if you want to create an undirected
     * edge, the edge set must contain both the forward and backwards edges.
     *
     * @param vertices The vertex set.
     * @param edges    The edge set.
     * @throws IllegalArgumentException If any of the arguments are null or if the
     *                                  vertex set doesn't contain all of the
     *                                  vertices.
     */
